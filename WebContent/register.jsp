...
<tr>
<td>帳號</td>
<td><input type="text" id="account" name="account" placeholder="請輸入5~20英數字"/></td>
<td>${err.account }${err.repeat}${err.accountformat }</td>
</tr>
<tr>
<td>密碼</td>
<td><input type="password" id="password" name="password" placeholder="請輸入5~20英數字"/></td>
<td>${err.password }${err.passwordformat }</td>
</tr>
<tr>
<td>確認密碼</td>
<td><input type="password" id="configpwd" name="configpwd" placeholder="請再輸入一次密碼"/></td>
<td>${err.againpwd }${err.checkpwd }</td>
</tr>
<tr>
<td>姓名</td>
<td><input type="text" id="username" name="username" placeholder="請輸入姓名"/></td>
<td>${err.userName }</td>
</tr>
<tr>
<td>信箱</td>
...
<tr>
<td>電話</td>
<td><input type="text" id="phone" name="phone" placeholder="請輸入電話號碼"/></td>
<td>${err.phone }</td>
</tr>
<tr>
<td>地址</td>
<td><input type="text" id="address" name="address" placeholder="請輸入地址"/></td>
<td>${err.address }</td>
</tr>
<tr>
<td>生日</td>
